...
//#endif
    ...
    IMGUI_API bool          ButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, const char* icon = "");
    IMGUI_API bool          IconButton(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, const char* icon = "");
    bool                    Product(const char* label, ImTextureID texture_id, int number, const char* subscribe, const char* last_update, const char* last_launch);
    ...
    // InputText
    IMGUI_API bool          InputTextEx(const char* label, const char* description, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback = NULL, void* user_data = NULL);
    void                    Textfield(const char* hint, char* buf, int buf_size, ImGuiInputTextFlags flags);
